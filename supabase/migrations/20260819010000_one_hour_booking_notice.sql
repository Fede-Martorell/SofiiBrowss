...
begin
  ...
  if v_start < timezone('America/Argentina/Buenos_Aires', now()) + interval '1 hour' then
    raise exception 'Los turnos deben solicitarse con al menos 1 hora de anticipación.'
      using errcode = '22023';
  end if;
